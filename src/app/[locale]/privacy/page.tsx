...
function PrivacyContent() {
  ...
  return <Section width="narrow"><Card><h1 className="text-3xl font-bold text-primary">{isAr?"سياسة الخصوصية":"Privacy Policy"}</h1><ul className="mt-5 space-y-3 text-primary-600"><li>{isAr?"نجمع بيانات التواصل الأساسية ومعلومات النشاط فقط لتقييم الطلب والرد.":"We collect basic contact details and activity information to assess your request and respond."}</li><li>{isAr?"قد يتم التواصل عبر واتساب أو البريد أو الهاتف حسب وسيلة الاتصال التي تختارها.":"We may communicate by WhatsApp, email, or phone based on your preference."}</li><li>{isAr?"نتعامل مع وثائق الشركات والهوية بسرية ولا نبيع بياناتك لأي طرف.":"Company and identity documents are handled confidentially and never sold."}</li><li>{isAr?"لا نطلب الوثائق الحساسة إلا عند الحاجة الفعلية للإجراء.":"We do not request sensitive documents until they are genuinely needed."}</li><li>{isAr?"يمكنك طلب تحديث أو حذف بياناتك عبر info@aseza.co.":"You can request data update or deletion via info@aseza.co."}</li></ul></Card></Section>;
}
