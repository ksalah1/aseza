...
export default async function Page({
  ...
  return (
    <AsezaBusinessGuide
      locale={locale}
      badge="قائمة تجهيز للمتطلبات اللاحقة"
      title="قائمة وثائق تسجيل شركة في ASEZA"
      hero="هذه القائمة تساعدك على التجهيز للمتطلبات اللاحقة. لا ترسل الوثائق قبل تحديد نطاق الخدمة والاتفاق على المتابعة."
      primaryCta="أرسل نوع الشركة والنشاط لنحدد القائمة المناسبة"
      secondaryCta="ابدأ تسجيل الشركة"
      secondaryHref="/register-business-in-aseza"
      whatsappMessage={`مرحباً، أريد معرفة المتطلبات المناسبة لتسجيل شركة في ASEZA.
نوع الشركة:
النشاط:`}
      ...
      mainTitle="متطلبات التجهيز بحسب نوع الشركة"
      mainItems={[
        {
      ...
      noteBody="هذه القائمة تساعدك على التجهيز للمتطلبات اللاحقة. لا ترسل الوثائق قبل تحديد نطاق الخدمة والاتفاق على المتابعة."
      finalCta="أرسل نوع الشركة والنشاط لنحدد القائمة المناسبة"
      related={[
