...
export async function generateMetadata({
  ...
  return buildMetadata({
    ...
    description: "مساعدة الشركات المسجلة في ASEZA على تعديل النشاط أو العنوان أو المفوضين أو الشركاء أو الاسم وتجهيز الوثائق المطلوبة.",
  ...
  return (
    <ServicePageTemplate
      content={{
        ...
        title: "تعديل بيانات شركة مسجلة في ASEZA",
        description: "نساعدك على تعديل النشاط، العنوان، المفوضين، الشركاء، الاسم، أو بيانات الشركة، مع تحديد الوثائق المطلوبة والخطوة الصحيحة قبل التقديم.",
        ctaLabel: "أرسل نوع التعديل",
        whatsappMessage: "أرغب في تعديل بيانات شركة مسجلة في ASEZA. نوع التعديل المطلوب:",
        ...
        whatWeDo: [
          ...
          "نرتب الوثائق والقرارات المطلوبة.",
        ...
        needs: [
          ...
          "أي وثائق داعمة للتعديل."
        ],
        steps: [
          "نحدد نوع التعديل بدقة.",
          "نراجع الوثائق المطلوبة لهذا النوع.",
