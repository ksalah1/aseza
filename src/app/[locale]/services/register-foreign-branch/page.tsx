  ...
  return (
    <ServicePageTemplate
      content={{
        ...
        ctaLabel: "أرسل بلد الشركة والنشاط المطلوب",
...
هل تريد فرعاً أم شركة جديدة أم أنك غير متأكد؟`,
        ...
        whatWeDo: [
          ...
          "نحدد المسار المناسب أولاً. بعد الاتفاق على المتابعة، نطلب وثائق الشركة الأم اللازمة.",
        ...
        steps: [
          ...
          "بعد الاتفاق على المتابعة، نرسل قائمة تجهيز التسجيل اللازمة بصيغة واضحة.",
        ...
        after: [
          ...
          "قائمة المتطلبات اللازمة للمرحلة التالية للشركة الأم والمفوضين.",
