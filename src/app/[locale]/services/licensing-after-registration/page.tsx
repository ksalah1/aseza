  ...
  return (
    <ServicePageTemplate
      content={{
        ...
        whatsappMessage: "أرغب في مراجعة متطلبات التشغيل بعد تسجيل الشركة في ASEZA. معلومات التشغيل:",
        secondaryCta: { label: "ما الذي نحتاجه؟", href: "#requirements" },
        whatWeDo: [
          "نراجع شهادة التسجيل والنشاط الفعلي.",
        ...
        needs: [
          ...
          "أي شهادات أو موافقات حصلت عليها سابقاً.",
          "الموعد المستهدف لبدء التشغيل."
        ],
        steps: [
          "نراجع التسجيل والنشاط.",
