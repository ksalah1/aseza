        ...
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-3xl text-lg leading-8 text-primary-600">
              اختر ما تحتاجه الآن: تسجيل شركة جديدة، تنظيم وجود شركة أجنبية، تحديد مسار نشاط، ترخيص بعد التسجيل، تعديل بيانات، أو تجديد سنوي. نبدأ بالمعلومات الأساسية ثم نحدد المسار والخدمة المناسبة قبل طلب الوثائق.
            </p>
            <a
