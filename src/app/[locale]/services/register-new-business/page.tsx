  ...
  return (
    <ServicePageTemplate
      content={{
        ...
        title: "تسجيل شركة / مؤسسة لأول مرة في ASEZA",
        description: "نساعدك على بدء ملف تسجيل شركة جديدة في العقبة، من تحديد النشاط والشكل المناسب إلى تجهيز المتطلبات والمتابعة بعد الاتفاق على نطاق الخدمة.",
        ctaLabel: "احصل على عرض خدمة تسجيل",
