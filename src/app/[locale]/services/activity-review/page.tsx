  ...
  return (
    <ServicePageTemplate
      content={{
        ...
        description: "نبدأ من وصف النشاط، وليس من مراجعة الوثائق. نوضح نموذج العمل، نحدد المسار المرجح للتسجيل، ونوصي بالخدمة المدفوعة المناسبة للمتابعة.",
        ctaLabel: "أرسل وصف النشاط لنحدد المسار",
