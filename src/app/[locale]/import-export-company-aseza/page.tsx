...
export async function generateMetadata({
  ...
  return buildMetadata({
    ...
    description:
      "خدمة استشارية لتجهيز تسجيل شركة استيراد وتصدير في منطقة العقبة الاقتصادية الخاصة، مع مراجعة النشاط، نوع البضائع، التخزين، والمتطلبات اللاحقة.",
...
export default async function Page({
  ...
  return (
    <AsezaBusinessGuide
      locale={locale}
      badge="تجهيز ومتابعة ملف التسجيل"
      title="تسجيل شركة استيراد وتصدير في العقبة / ASEZA"
      hero="نساعدك على تجهيز ملف شركة استيراد وتصدير في العقبة، مع مراجعة نوع البضائع، النشاط، التخزين، الجمارك، ومتطلبات التشغيل قبل بدء التسجيل."
      primaryCta="أرسل نوع البضائع والنشاط"
      secondaryCta="راجع النشاط قبل التسجيل"
      secondaryHref="/services/activity-review"
      whatsappMessage="مرحباً، أريد تسجيل شركة استيراد وتصدير في العقبة. نوع البضائع: ... هل يوجد تخزين أو إعادة تصدير؟ ..."
      ...
      help={[
        "صياغة النشاط",
        "تحديد الوثائق",
        "مراجعة متطلبات التخزين أو الموقع",
        "توضيح الخطوة التالية بعد التسجيل",
        "ربطك بصفحة الرسوم والوثائق",
      ]}
      ...
      finalCta="أرسل نوع البضائع والنشاط"
      related={[
