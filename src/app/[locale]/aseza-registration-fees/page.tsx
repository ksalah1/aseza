...
export default async function Page({
  ...
  return (
    <AsezaBusinessGuide
      ...
      primaryCta="احصل على تقدير تكلفة التسجيل"
      secondaryCta="اطّلع على قائمة التجهيز"
      secondaryHref="/aseza-registration-checklist"
      whatsappMessage={`مرحباً، أريد تقدير تكلفة تسجيل شركة في ASEZA.
نوع الشركة:
عدد الأنشطة:
هل يوجد شركاء أجانب؟`}
      ...
      noteBody="أتعاب تجهيز ومتابعة الملف منفصلة عن الرسوم الرسمية. نوضح لك البنود قبل البدء حتى تكون الصورة التجارية واضحة. تقدير الأتعاب لا يشمل مراجعة تفصيلية للوثائق قبل الاتفاق على نطاق الخدمة."
      finalCta="أرسل نوع الشركة وعدد الأنشطة لتحصل على تقدير واضح"
      related={[
        { href: "/register-business-in-aseza", label: "تسجيل شركة في ASEZA" },
        { href: "/aseza-registration-checklist", label: "قائمة التجهيز" },
