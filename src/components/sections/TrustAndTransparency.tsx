...
export function TrustAndTransparency() {
  ...
  const trustCards = [
    ["محامية مرخّصة", "مراجعة قانونية مباشرة من محامية مرخّصة وعضو في نقابة المحامين الأردنيين."],
    ["مراجعة النشاط قبل التقديم", "نحدد ملاءمة النشاط والمتطلبات المتوقعة قبل بدء المعاملة."],
    ["أتعاب واضحة", "فصل واضح بين أتعابنا والرسوم الحكومية أو رسوم الجهات الثالثة."],
    ["مراجع رسمية", "نوفر مصادر رسمية حتى تبني قرارك على نصوص وتشريعات واضحة."],
    ["لا وعود غير واقعية", "الموافقة النهائية تبقى للجهة المختصة، ونحن نوضح ذلك صراحة."],
    ["ملائم للمستثمر المحلي والأجنبي", "دعم للوثائق والتفويضات والمتطلبات العابرة للحدود حسب الحالة."],
  ];
